/*
 ...
 The majority of this code was written from scratch.  I implemented various concepts and ideas
 from other students code when I had reached a point where I couldn't move any further.  During
 the writing of this program, I became much better with pointers, command line arguments, and
 file manipulation via fopen(), fread(), fwrite() functions.
